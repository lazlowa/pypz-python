...
class ChannelStatusMonitorTest(unittest.TestCase):
    ...
    def on_status_update_without_payload_func(
        self, status_message: ChannelStatusMessage
    ):
        self.assertEqual(1, status_message.timestamp)
        self.assertIsNone(status_message.payload)

    def test_test_update_status_monitor_without_payload_and_callback_expect_success(
        self,
    ):
        monitor = ChannelStatusMonitor("channelName", "ownerName")
        monitor.last_update_sent_timestamp_ms = 0
    ...
    def test_health_check_no_status_update_expect_unhealthy(self):
        monitor = ChannelStatusMonitor("channelName", "ownerName")
        monitor.monitor_start_timestamp = (
            current_time_millis() - ChannelStatusMonitor.ValidPatienceTimeInMs - 100
        )
    ...
    def test_get_channel_names_if_channel1_name_contains_string_expect_success(self):
        ...
        channel_base._status_map["channel1"] = ChannelStatusMonitor(
            "channel1", "ownerName", None, channel_base._logger
        )
        channel_base._status_map.get("channel1").update(
            ChannelStatusMessage(
        ...
        self.assertEqual(
            1,
            len(
                channel_base.retrieve_connected_channel_unique_names(
    ...
    def test_get_channel_names_if_with_valid_statuses_expect_success(self):
        ...
        channel_base._status_map["channel2"] = ChannelStatusMonitor(
            "channel2", "ownerName", None, channel_base._logger
        )
        channel_base._status_map.get("channel2").update(
            ChannelStatusMessage(
        ...
        channel_base._status_map["channel3"] = ChannelStatusMonitor(
            "channel3", "ownerName", None, channel_base._logger
        )
        channel_base._status_map.get("channel3").update(
            ChannelStatusMessage(
        ...
        channel_base._status_map["channel4"] = ChannelStatusMonitor(
            "channel4", "ownerName", None, channel_base._logger
        )
        channel_base._status_map.get("channel4").update(
            ChannelStatusMessage(
        ...
        channel_base._status_map["channel5"] = ChannelStatusMonitor(
            "channel5", "ownerName", None, channel_base._logger
        )
        channel_base._status_map.get("channel5").update(
            ChannelStatusMessage(
        ...
        channel_base._status_map["channel6"] = ChannelStatusMonitor(
            "channel6", "ownerName", None, channel_base._logger
        )

        self.assertEqual(
            6, len(channel_base.retrieve_connected_channel_unique_names(None))
        )
