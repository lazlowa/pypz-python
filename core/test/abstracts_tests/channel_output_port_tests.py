...
class ChannelOutputPortTest(unittest.TestCase):
    ...
    def test_channel_output_port_on_resource_creation_expect_initialized_channels_and_created_resources(self):
        ...
        self.assertNotIn(pipeline.reader.input_port_a.get_full_name(),
                         TEST_DATA_TRANSFER_MEDIUM)
        self.assertNotIn(pipeline.reader.input_port_a.get_full_name() + OUTPUT_STATE_POSTFIX,
                         TEST_CONTROL_TRANSFER_MEDIUM)
        self.assertNotIn(pipeline.reader.input_port_a.get_full_name() + INPUT_STATE_POSTFIX,
                         TEST_CONTROL_TRANSFER_MEDIUM)
        self.assertNotIn(pipeline.reader.input_port_b.get_full_name(), TEST_DATA_TRANSFER_MEDIUM)
        self.assertNotIn(pipeline.reader.input_port_b.get_full_name() + OUTPUT_STATE_POSTFIX,
                         TEST_CONTROL_TRANSFER_MEDIUM)
        self.assertNotIn(pipeline.reader.input_port_b.get_full_name() + INPUT_STATE_POSTFIX,
                         TEST_CONTROL_TRANSFER_MEDIUM)
        ...
        self.assertIsNone(TEST_CONTROL_TRANSFER_MEDIUM[pipeline.reader.input_port_a.get_full_name() +
                                                       OUTPUT_STATE_POSTFIX])
        self.assertIsNone(TEST_CONTROL_TRANSFER_MEDIUM[pipeline.reader.input_port_a.get_full_name() +
                                                       INPUT_STATE_POSTFIX])
        self.assertIsNone(TEST_DATA_TRANSFER_MEDIUM[pipeline.reader.input_port_b.get_full_name()])
        self.assertIsNone(TEST_CONTROL_TRANSFER_MEDIUM[pipeline.reader.input_port_b.get_full_name() +
                                                       OUTPUT_STATE_POSTFIX])
        self.assertIsNone(TEST_CONTROL_TRANSFER_MEDIUM[pipeline.reader.input_port_b.get_full_name() +
                                                       INPUT_STATE_POSTFIX])
    ...
    def test_channel_output_port_on_port_close_unfinished(self):
        ...
        self.assertIsNotNone(TEST_DATA_TRANSFER_MEDIUM[pipeline.reader.input_port_a.get_full_name()])
        self.assertIsNotNone(TEST_CONTROL_TRANSFER_MEDIUM[pipeline.reader.input_port_a.get_full_name() +
                                                          OUTPUT_STATE_POSTFIX])
        self.assertIsNotNone(TEST_CONTROL_TRANSFER_MEDIUM[pipeline.reader.input_port_a.get_full_name() +
                                                          INPUT_STATE_POSTFIX])
        self.assertIsNotNone(TEST_DATA_TRANSFER_MEDIUM[pipeline.reader.input_port_b.get_full_name()])
        self.assertIsNotNone(TEST_CONTROL_TRANSFER_MEDIUM[pipeline.reader.input_port_b.get_full_name() +
                                                          OUTPUT_STATE_POSTFIX])
        self.assertIsNotNone(TEST_CONTROL_TRANSFER_MEDIUM[pipeline.reader.input_port_b.get_full_name() +
                                                          INPUT_STATE_POSTFIX])
