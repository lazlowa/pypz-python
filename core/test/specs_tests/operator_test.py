...
class OperatorInstanceTest(unittest.TestCase):
    ...
    def test_operator_replication_basic_attributes(self):
        ...
        self.assertEqual(pipeline.operator_a.output_port.get_full_name(), pipeline.operator_a.output_port.get_group_name())
        ...
        self.assertEqual(pipeline.operator_a.input_port.get_full_name(), pipeline.operator_a.input_port.get_group_name())
    ...
    def test_operator_replication_direct_set_parameter_attribute_expect_equality(self):
        ...
        for replica_idx in range(pipeline.operator_a.get_replication_factor()):
            ...
            self.assertIs(pipeline.operator_a.get_protected().get_parameters(), replica.get_protected().get_parameters())
    ...
    def test_operator_replication_replica_equality_without_updates(self):
        ...
        for replica in operator.get_replicas():
            ...
            self.assertEqual(operator.get_protected().get_nested_instances(), replica.get_protected().get_nested_instances())
    ...
    def test_operator_replication_replica_equality_with_updates_on_origin(self):
        ...
        for replica in operator.get_replicas():
            self.assertEqual(operator.get_protected().get_nested_instances(), replica.get_protected().get_nested_instances())
            self.assertEqual(id(operator.get_protected().get_parameters()), id(replica.get_protected().get_parameters()))
            self.assertEqual(id(operator.get_protected().get_depends_on()), id(replica.get_protected().get_depends_on()))
            self.assertEqual(id(operator.output_port.get_protected().get_parameters()), id(replica.output_port.get_protected().get_parameters()))
            self.assertEqual(id(operator.output_port.get_protected().get_depends_on()), id(replica.output_port.get_protected().get_depends_on()))
            self.assertEqual(id(operator.input_port.get_protected().get_parameters()), id(replica.input_port.get_protected().get_parameters()))
            self.assertEqual(id(operator.input_port.get_protected().get_depends_on()), id(replica.input_port.get_protected().get_depends_on()))
