...
from pypz.core.specs.plugin import ServicePlugin, ResourceHandlerPlugin, InputPortPlugin, OutputPortPlugin, \
    PortPlugin, Plugin
...
class ExecutionContextTest(unittest.TestCase):
    ...
    def test_context_with_runtime_template_parameter(self):
        ...
        self.assertEqual("$(env:PYPZ_TEST_ENV_VAR)",
        ...
        self.assertEqual({"env": "$(env:PYPZ_TEST_ENV_VAR)"},
        ...
        self.assertEqual({"env": "testValue"},
                         pipeline.operator_b.service_plugin_0.get_parameter("test_env_var_dict"))
    ...
    def test_context_with_independent_plugins_of_different_types(self):
        ...
        self.assertTrue(pipeline.operator_b.resource_handler_0 in
                        context.get_plugin_instances_by_type(ResourceHandlerPlugin))
        self.assertTrue(pipeline.operator_b.resource_handler_1 in
                        context.get_plugin_instances_by_type(ResourceHandlerPlugin))
        self.assertTrue(pipeline.operator_b.resource_handler_2 in
                        context.get_plugin_instances_by_type(ResourceHandlerPlugin))
        self.assertTrue(pipeline.operator_b.resource_handler_3 in
                        context.get_plugin_instances_by_type(ResourceHandlerPlugin))
        self.assertTrue(pipeline.operator_b.resource_handler_4 in
                        context.get_plugin_instances_by_type(ResourceHandlerPlugin))
        ...
        self.assertTrue(pipeline.operator_b.resource_handler_0 in
                        context.get_dependency_graph_by_type(ResourceHandlerPlugin)[0])
        self.assertTrue(pipeline.operator_b.resource_handler_1 in
                        context.get_dependency_graph_by_type(ResourceHandlerPlugin)[0])
        self.assertTrue(pipeline.operator_b.resource_handler_2 in
                        context.get_dependency_graph_by_type(ResourceHandlerPlugin)[0])
    ...
    def test_context_with_dependent_plugins_of_different_types(self):
        ...
        self.assertTrue(pipeline.operator_b.resource_handler_0 in
                        context.get_dependency_graph_by_type(ResourceHandlerPlugin)[0])
        self.assertTrue(pipeline.operator_b.resource_handler_1 in
                        context.get_dependency_graph_by_type(ResourceHandlerPlugin)[1])
        self.assertTrue(pipeline.operator_b.resource_handler_2 in
                        context.get_dependency_graph_by_type(ResourceHandlerPlugin)[2])
        self.assertTrue(pipeline.operator_b.resource_handler_3 in
                        context.get_dependency_graph_by_type(ResourceHandlerPlugin)[3])
        self.assertTrue(pipeline.operator_b.resource_handler_4 in
                        context.get_dependency_graph_by_type(ResourceHandlerPlugin)[4])
