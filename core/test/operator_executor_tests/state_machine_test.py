...
class OperatorStateMachineTest(unittest.TestCase):
    ...
    def test_transition_from_state_entry_expect_success(self):
        ...
        self.assertIsInstance(
            ex.get_current_state().on_signal_handling(SignalNoOp()), StateEntry
        )
        self.assertIsInstance(
            ex.get_current_state().on_signal_handling(SignalServicesStart()),
            StateServiceStart,
        )
        self.assertIsInstance(
            ex.get_current_state().on_signal_handling(SignalResourcesCreation()),
            StateEntry,
        )
        self.assertIsInstance(
            ex.get_current_state().on_signal_handling(SignalOperationInit()), StateEntry
        )
        self.assertIsInstance(
            ex.get_current_state().on_signal_handling(SignalOperationStart()),
            StateEntry,
        )
        self.assertIsInstance(
            ex.get_current_state().on_signal_handling(SignalOperationStop()), StateEntry
        )
        self.assertIsInstance(
            ex.get_current_state().on_signal_handling(SignalResourcesDeletion()),
            StateEntry,
        )
        self.assertIsInstance(
            ex.get_current_state().on_signal_handling(SignalServicesStop()), StateEntry
        )
        self.assertIsInstance(
            ex.get_current_state().on_signal_handling(SignalKill()), StateEntry
        )
        self.assertIsInstance(
            ex.get_current_state().on_signal_handling(SignalTerminate()), StateEntry
        )
        self.assertIsInstance(
            ex.get_current_state().on_signal_handling(SignalError()), StateEntry
        )
        self.assertIsInstance(
            ex.get_current_state().on_signal_handling(SignalShutdown()), StateKilled
        )
    ...
    def test_transition_from_state_start_services_expect_success(self):
        ...
        self.assertIsInstance(
            ex.get_current_state().on_signal_handling(SignalNoOp()), StateServiceStart
        )
        self.assertIsInstance(
            ex.get_current_state().on_signal_handling(SignalServicesStart()),
            StateServiceStart,
        ...
        self.assertIsInstance(
            ex.get_current_state().on_signal_handling(SignalOperationInit()),
            StateServiceStart,
        )
        self.assertIsInstance(
            ex.get_current_state().on_signal_handling(SignalOperationStart()),
        ...
        self.assertIsInstance(
            ex.get_current_state().on_signal_handling(SignalOperationStop()),
            StateServiceStart,
        )
        self.assertIsInstance(
            ex.get_current_state().on_signal_handling(SignalResourcesDeletion()),
        ...
        self.assertIsInstance(
            ex.get_current_state().on_signal_handling(SignalServicesStop()),
            StateServiceStart,
        )
        self.assertIsInstance(
            ex.get_current_state().on_signal_handling(SignalKill()), StateServiceStart
        )
        self.assertIsInstance(
            ex.get_current_state().on_signal_handling(SignalTerminate()),
            StateServiceStart,
        )
        self.assertIsInstance(
            ex.get_current_state().on_signal_handling(SignalError()),
            StateServiceShutdown,
        )
        self.assertIsInstance(
            ex.get_current_state().on_signal_handling(SignalShutdown()),
            StateServiceShutdown,
        )
    ...
    def test_transition_from_state_resource_creation_expect_success(self):
        ...
        self.assertIsInstance(
            ex.get_current_state().on_signal_handling(SignalNoOp()),
            StateResourceCreation,
        )
        self.assertIsInstance(
            ex.get_current_state().on_signal_handling(SignalServicesStart()),
        ...
        self.assertIsInstance(
            ex.get_current_state().on_signal_handling(SignalKill()),
            StateResourceCreation,
        )
        self.assertIsInstance(
            ex.get_current_state().on_signal_handling(SignalTerminate()),
    ...
    def test_transition_from_state_operation_init_expect_success(self):
        ...
        self.assertIsInstance(
            ex.get_current_state().on_signal_handling(SignalNoOp()), StateOperationInit
        )
        self.assertIsInstance(
            ex.get_current_state().on_signal_handling(SignalServicesStart()),
            StateOperationInit,
        ...
        self.assertIsInstance(
            ex.get_current_state().on_signal_handling(SignalKill()), StateOperationInit
        )
        self.assertIsInstance(
            ex.get_current_state().on_signal_handling(SignalTerminate()),
            StateOperationInit,
    ...
    def test_transition_from_state_service_shutdown_expect_success(self):
        ...
        self.assertIsInstance(
            ex.get_current_state().on_signal_handling(SignalKill()), StateKilled
        )
        self.assertIsInstance(
            ex.get_current_state().on_signal_handling(SignalTerminate()),
            StateServiceShutdown,
        ...
        self.assertIsInstance(
            ex.get_current_state().on_signal_handling(SignalError()), StateKilled
        )
        self.assertIsInstance(
            ex.get_current_state().on_signal_handling(SignalShutdown()),
            StateServiceShutdown,
