...
class OperatorStateMachineTest(unittest.TestCase):
    ...
    def test_transition_from_state_start_services_expect_success(self):
        ...
        self.assertIsInstance(ex.get_current_state().on_signal_handling(SignalServicesStart()), StateServiceStart)
        self.assertIsInstance(ex.get_current_state().on_signal_handling(SignalResourcesCreation()), StateResourceCreation)
        ...
        self.assertIsInstance(ex.get_current_state().on_signal_handling(SignalResourcesDeletion()), StateResourceDeletion)
    ...
    def test_transition_from_state_resource_creation_expect_success(self):
        ...
        self.assertIsInstance(ex.get_current_state().on_signal_handling(SignalResourcesDeletion()), StateResourceCreation)
    ...
    def test_transition_from_state_operation_running_expect_success(self):
        ...
        self.assertIsInstance(ex.get_current_state().on_signal_handling(SignalResourcesCreation()), StateOperationRunning)
        ...
        self.assertIsInstance(ex.get_current_state().on_signal_handling(SignalResourcesDeletion()), StateOperationRunning)
    ...
    def test_transition_from_state_operation_shutdown_expect_success(self):
        ...
        self.assertIsInstance(ex.get_current_state().on_signal_handling(SignalResourcesCreation()), StateOperationShutdown)
    ...
    def test_transition_from_state_resource_deletion_expect_success(self):
        ...
        self.assertIsInstance(ex.get_current_state().on_signal_handling(SignalResourcesCreation()), StateResourceDeletion)
    ...
    def test_transition_from_state_service_shutdown_expect_success(self):
        ...
        self.assertIsInstance(ex.get_current_state().on_signal_handling(SignalResourcesCreation()), StateServiceShutdown)
        ...
        self.assertIsInstance(ex.get_current_state().on_signal_handling(SignalResourcesDeletion()), StateServiceShutdown)
        self.assertIsInstance(ex.get_current_state().on_signal_handling(SignalServicesStop()), StateServiceShutdown)
