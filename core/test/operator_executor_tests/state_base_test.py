...
from pypz.executors.operator.signals import SignalOperationStart, SignalOperationStop, SignalServicesStop, \
    SignalServicesStart, SignalResourcesCreation, SignalResourcesDeletion, SignalOperationInit, SignalError, SignalKill, \
    SignalNoOp, SignalShutdown, SignalTerminate
